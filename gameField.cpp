...
void gameField::edit_node_brethe(id_node* _node, int _new_val) {
	if (_node->place_hei > height_field || _node->place_wid > width_field) {
		...
		field[_node->place_hei][_node->place_wid]->freeBrethe = _new_val;
	}
...
void gameField::re_calc_brethe(id_node* _node) {
	if (_node->place_hei - 1 >= 0) {
		if (!field[_node->place_hei - 1][_node->place_wid]->is_free) {
			field[_node->place_hei - 1][_node->place_wid]->freeBrethe--;
			field[_node->place_hei][_node->place_wid]->freeBrethe--;
		}
	}
	if (_node->place_hei + 1 < height_field) {
		if (!field[_node->place_hei - 1][_node->place_wid]->is_free) {
			field[_node->place_hei + 1][_node->place_wid]->freeBrethe--;
			field[_node->place_hei][_node->place_wid]->freeBrethe--;
		}
	}
	if (_node->place_wid - 1 >= 0) {
		if (!field[_node->place_hei - 1][_node->place_wid]->is_free) {
			field[_node->place_hei][_node->place_wid - 1]->freeBrethe--;
			field[_node->place_hei][_node->place_wid]->freeBrethe--;
		}
	}
	if (_node->place_wid + 1 < height_field) {
		if (!field[_node->place_hei - 1][_node->place_wid]->is_free) {
			field[_node->place_hei][_node->place_wid + 1]->freeBrethe--;
			field[_node->place_hei][_node->place_wid]->freeBrethe--;
		}
